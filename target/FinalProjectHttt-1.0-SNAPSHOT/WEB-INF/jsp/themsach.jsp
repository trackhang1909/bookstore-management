...
<html>
    ...
    <body>
        ...
        <div style="padding: 30px 100px 100px 100px">
            ...
            <c1:form method="post" commandName="sach" action="themsach.htm" enctype="multipart/form-data">
                ...
                <hr>
                <div class="form-group">
                    <label class="font-weight-bold">Trọng lượng (gr)</label>
                ...
                <div class="form-group">
                    ...
                    <c1:input path="kichThuoc" cssClass="form-control" placeholder="DàixRộngxCao"/>
                    <c1:errors path="kichThuoc" cssClass="error"/>
                </div>
                <hr>
                <div class="form-group">
                    <label class="font-weight-bold">Số lượng</label>
                    <c1:input path="soLuong" cssClass="form-control" placeholder=""/>
                    <c1:errors path="soLuong" cssClass="error"/>
                </div>
                <hr>
                <div class="form-group">
                    <label class="font-weight-bold">Hình thức</label>
                    <c1:input path="hinhThuc" cssClass="form-control" placeholder="Bìa Mềm"/>
                ...
                <div class="form-group">
                    ...
                    <c1:errors path="hinh1" cssClass="error"/>
                </div>
                <div class="form-group">
                    <label class="font-weight-bold">Hình 2</label>
                    <input type="file" name="file"/>
                    <c1:errors path="hinh2" cssClass="error"/>
                </div>
                <div class="form-group">
                    <label class="font-weight-bold">Hình 3</label>
                    <input type="file" name="file"/>
                    <c1:errors path="hinh3" cssClass="error"/>
                </div>
                <div class="form-group">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                Bạn chắc chắn muốn thêm sách mới ?
                            </div>
