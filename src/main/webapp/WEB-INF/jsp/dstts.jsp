...
<html>
    <head>
        ...
        <title>Danh sách Tình trạng sách</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="rounded-lg mx-5 my-5" style="background-color: white;">
                <h1 class="text-center" style="padding-top: 30px">Danh sách Tình trạng sách</h1>
        ...
        <div style="margin: 20px; overflow: auto">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Tình trạng sách:</label>
            ...
            <table class="table table-hover table-bordered">
                <thead class="thead-light">
                    <tr>
                        <th scope="col">Mã tình trạng sách</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c1:form method="post" action="suatts.htm">
                                    ...
                                    <button type="button" class="btn btn-light btn-outline-info btn-sm" data-toggle="modal" data-target="#exampleModal${it.maTTS}">Chỉnh sửa</button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">Mã tình trạng sách: </label>
                                    ...
                                    <div class="modal fade" id="exampleModalx${it.maTTS}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
                                                    <a class="btn btn-primary" role="button" href="xoatts.htm?id=${it.maTTS}">Đồng ý</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
